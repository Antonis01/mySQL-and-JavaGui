 ...
 * @author efrai
 */
public class DeleteEventDataFrame extends javax.swing.JFrame {

    /**
     * Creates new form DeleteEventDataFrame
     */
    public DeleteEventDataFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Delete Data from Event");
    ...
    private void DeleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeleteButtonActionPerformed
        ...
        try {
            ...
            pstmt = con.getConnection().prepareStatement(delete_event);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeleteEventDataFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeleteEventDataFrame().setVisible(true);
            }
        });
    }
