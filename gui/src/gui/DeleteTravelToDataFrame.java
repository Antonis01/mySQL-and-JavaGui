 ...
 * @author efrai
 */
public class DeleteTravelToDataFrame extends javax.swing.JFrame {

    /**
     * Creates new form DeleteTravelToDataFrame
     */
    public DeleteTravelToDataFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Delete Data from Travel To");
    ...
    private void DeleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeleteButtonActionPerformed
        ...
        try {
            ...
            pstmt = con.getConnection().prepareStatement(delete_travel_to);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeleteTravelToDataFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeleteTravelToDataFrame().setVisible(true);
            }
        });
    }
